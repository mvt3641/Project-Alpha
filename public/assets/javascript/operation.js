...
var table = new Tabulator("#flightlogtb", {
 	...
 	columns: [{title: "Date Logged",field:"dateLogged"},
            {title: "User",field:"User"},
            {title: "Time",field: "Time"},
            {title: "system",field: "system"},
            {title: "System Status", field: "systemStatus"},
            {title: "Flight Altitude", field: "flightAltitude"},
            {title: "Reason Moored", field:"reasonMoored"},
            {title: "Launches", field: "Launches"},
            {title: "Recoveries", field: "recoveries"},
            {title: "Tether Tension",field: "tetherTension"},
            {title: "Ground Winds", field: "groundWinds"},
            {title: "Winds Aloft",field: "windsAloft"},
            {title: "Ground Temperature", field:"groundTemp"},
            {title: "Barometric Pressure",field: "barometricPressure"},
            {title: "Pitch", field: "pitch"},
            {title: "Helium Pressure", field: "heliumPressure"},
            {title: "Ballonet Pressure", field: "ballonetPressure"},
